...
class WaitingSpinner(QWidget):
    ...
    def __init__(
        ...
        self._color: QColor = QColor(197, 54, 231)
        self._roundness: float = 82.99
        self._minimum_trail_opacity: float = 9.0
        self._trail_fade_percentage: float = 70.0
        self._revolutions_per_second: float = speed
        self._number_of_lines: int = 78
        self._line_length: int = 5
        self._line_width: int = 5
        self._inner_radius: int = 7
